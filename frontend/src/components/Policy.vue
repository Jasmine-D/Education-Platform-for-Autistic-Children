<template>
    <q-dialog v-model="policy" full-height>
        <q-card style="width:35vw;max-width:80vw;">
            <q-card-section style="text-align:center">
                <div class="text-h5">隐私声明</div>
            </q-card-section>

            <q-card-section class="q-pt-none">
                <p class="text-h6">一、隐私政策</p>
                <p class="text-h7" style="text-indent:2em;">
                ...
                <p class="text-h6">二、适用范围</p>
                <p class="text-h7" style="text-indent:2em;">
                    (1) 在您注册本应用帐号时，您根据本应用要求提供的个人注册信息；
                </p>
                <p class="text-h7" style="text-indent:2em;">
                    (2) 在您使用本应用网络服务，或访问本应用平台网页时，本应用自动接收并记录的您的浏览器和计算机上的信息，
                    包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；
                </p>
                <p class="text-h7" style="text-indent:2em;">
                    (3) 本应用通过合法途径从商业伙伴处取得的用户个人数据。
                </p>
                <p class="text-h6">三、您了解并同意，以下信息不适用本隐私权政策：</p>
                <p class="text-h7" style="text-indent:2em;">
                ...
                <p class="text-h6">四、信息使用</p>
                <p class="text-h7" style="text-indent:2em;">
                    (1)本应用不会向任何无关第三方提供、出售、出租、分享或交易您的个人信息，除非事先得到您的许可，
                ...
                <p class="text-h7" style="text-indent:2em;">
                     (6) 在本应用平台上创建的某一交易中，如交易任何一方履行或部分履行了交易义务并提出信息披露请求的，
                    本应用有权决定向该用户提供其交易对方的联络方式等必要信息，以促成交易的完成或纠纷的解决。
                </p>
                <p class="text-h7" style="text-indent:2em;">
                     (7) 其它本应用根据法律、法规或者网站政策认为合适的披露。
                </p>
                <p class="text-h6">六、信息存储和交换</p>
                <p class="text-h7" style="text-indent:2em;">
                     本应用收集的有关您的信息和资料将保存在本应用及（或）其关联公司的服务器上，
                    这些信息和资料可能传送至您所在国家、地区或本应用收集信息和资料所在地的境外并在境外被访问、存储和展示。
                </p>
                <p class="text-h7" style="text-indent:2em;">
                    Cookie的使用:
                </p>
                ...
                <p class="text-h7" style="text-indent:2em;">
                     (4) 本应用帐号均有安全保护功能，请妥善保管您的用户名及密码信息。本应用将通过对用户密码进行加密等安全措施确保您的信息不丢失，不被滥用和变造。
                    尽管有前述安全措施，但同时也请您注意在信息网络上不存在“完善的安全措施”。
                </p>
                <p class="text-h7" style="text-indent:2em;">
                     (5) 在使用本应用网络服务进行网上交易时，您不可避免的要向交易对方或潜在的交易对象展示您的信息t和资料。
                </p>
                <p class="text-h6">七、本隐私政策的更改</p>
                <p class="text-h7" style="text-indent:2em;">
                ...
                <p class="text-h7" style="text-indent:2em;">
                     如您对本政策或其他相关事宜有疑问，请将您的问题发送至1854307@tongji.edu.cn。
                </p>
            </q-card-section>

            <q-card-actions align="right">
            <q-btn flat label="确定" color="primary" @click="closePolicy()" />
            </q-card-actions>
        </q-card>
    </q-dialog>
</template>
